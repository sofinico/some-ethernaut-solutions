...
async function getConsumedGas() {
  ...
  const txHash =
    "0x4c50f2e5aa9a8afbfe7dd128ccb80543043ee6bdbd0ab98a59593bd1447b3690";
  ...
  // console.log(txData);
  const decodedData = ISolution.parseTransaction({
    data: txData,
  ...
  console.log(
    `Total forwarded gas to GatekeeperOne.entrant(): ${forwardedGas.toString()}`
  );
